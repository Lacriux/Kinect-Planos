...
def change_threshold(value):
    ...
    fixed_threshold = value

def change_depth(value):
    global fixed_depth
    fixed_depth = value

def change_depth2(value):
    global fixed_depth2
    fixed_depth2 = value
...
def show_video(image, image_name):	
	...
	cv2.createTrackbar('Min Range', image_name, fixed_depth2, 600, change_depth2)
	cv2.createTrackbar('Max Range', image_name, fixed_depth, 600, change_depth)
