...
def draw_lines_1_and_3(imagen): #draws lines to divide the camara for 1 or 3 users
	
	#vetical lines
	cv2.line(imagen,(20,10),(20,425),(0,250,0),2)
	cv2.line(imagen,(220,10),(220,425),(250,250,250),2)	
	cv2.line(imagen,(420,10),(420,425),(250,250,250),2)
	cv2.line(imagen,(120,380),(120,425),(250,250,250),2)
	cv2.line(imagen,(320,380),(320,425),(250,250,250),2)
	cv2.line(imagen,(420,380),(420,425),(250,250,250),2)
	cv2.line(imagen, (620, 10), (620, 425), (0,250,0),2)
	
	#horizontal lines
	cv2.line(imagen, (20, 10), (620, 10), (0,250,0),2)
	cv2.line(imagen, (20, 80), (620, 80), (250,250,250),2)

	cv2.line(imagen, (20, 380), (620, 380), (250,250,250),2)
	
	cv2.line(imagen, (20, 425), (620, 425), (0,250,0),2)
	
	
	return imagen

def draw_lines_2_and_4(imagen): #draws lines to divide the camara for 2 or 4 users
...
#def draw_lines_9(imagen): #draws lines to divide the camara for user
	...
	#vetical lines
#	cv2.line(imagen,(213,10),(213,480),(255,250,250),2)
	
#	cv2.line(imagen,(426,10),(426,480),(255,250,250),2)
...
def define_lineas(str_divisiones):
	if(str_divisiones == "1" or str_divisiones == "3"):
		imagen_lineas = draw_lines_1_and_3(image)
		return 1
	elif(str_divisiones == "2" or str_divisiones == "4"):
		imagen_lineas = draw_lines_2_and_4(image)
		return 1
	elif(str_divisiones == "5"):
		imagen_lineas = draw_lines_5(image)
		return 1
	else:
...
if __name__ == "__main__":
	...
	while 1:
		...
		#str_nota = sys.argv[1]
		str_divisiones = sys.argv[1]
		
		#### definir divisiones
		bool_lineas = 1

		define_lineas(str_divisiones)
